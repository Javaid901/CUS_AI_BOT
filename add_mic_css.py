...
# Add mic button styles right before the send button styles
mic_styles = '''#cusw .input-wrap .mic {
...
# Find the position of '#cusw .input-wrap .send {'
...
if pos >= 0:
    ...
    with open('frontend/css/chatbot.css', 'w', errors='replace') as f:
        f.write(new_content)
    print('Successfully added mic CSS styles')
else:
